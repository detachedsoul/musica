		...
		<>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div className="lg:col-span-5">
                    ...
                    <div className="lg:grid gap-2 flex items-center overflow-x-auto custom-scrollbar py-4 snap-mandatory snap-x">
                        <TopCharts />
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="gap-4 flex justify-between overflow-x-auto custom-scrollbar py-4 snap-mandatory snap-x">
                    <NewReleases />
                </div>
            </div>
