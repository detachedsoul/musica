...
const Home = () => {
    return (
		<>
            ...
            <div className="px-4 py-12 space-y-8 lg:space-y-12 lg:pl-20 lg:pr-6 lg:py-4">
                ...
                <div>
                    ...
                    <div className="gap-4 flex justify-between overflow-x-auto custom-scrollbar py-4">
                        <NewReleases />
                    </div>
                </div>
